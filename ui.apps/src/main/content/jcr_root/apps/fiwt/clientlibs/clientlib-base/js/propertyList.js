...
// Usage
const searchInput = getQueryParam('searchInput');
const propertyType = getQueryParam('propertyType');
const locationType = getQueryParam('locationType');
$.ajax({
                    type: "GET",
                    url: '/content/fiwt/lm/en/home/search/jcr:content/root/responsivegrid/propertysearch',
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        if (data != null) {
                            ...
                            for (let i = 0; i < data.length; i++) {
                                propertyList += "<div class='col-lg-4 col-md-6 wow fadeInUp' data-wow-delay=0."+i+"s' style='visibility: visible; animation-delay:0."+i+"s'; animation-name: fadeInUp;'>" +
                            ...
                            document.getElementById("propertyListCards").innerHTML = "<div class='tab-pane fade show p-0 active'>" +
                                "<div class='row g-4'>" + propertyList
                            "</div>" +
                                "</div>";
